...
export class ProductoService {
  ...
  /**
   * Lista productos por tienda - GET /productos/tienda/{tiendaId} (público)
   */
  findByTiendaId(tiendaId: number): Observable<ProductoDTO[]> {
    return this.http.get<ProductoDTO[]>(`${API_URL}/productos/tienda/${tiendaId}`);
  }
