...
public class TiendaServiceImpl implements TiendaService{
    ...
    public TiendaServiceImpl(TiendaRepository tiendaRepository, UsuarioRepository usuarioRepository, PixabayService pixabayService) {
    ...
    public TiendaDTO save(TiendaDTO dto) {
        ...
        if (dto.getImagenUrl() == null || dto.getImagenUrl().isBlank()) {
            dto.setImagenUrl(pixabayService.buscarImagen("tienda"));
        }
    ...
    public List<TiendaDTO> findAll() {
        ...
        for (Tienda tienda : listaTiendas) {
            String imgUrl = tienda.getImagenUrl();
            if (imgUrl == null || imgUrl.isBlank()) {
                imgUrl = pixabayService.buscarImagen("tienda");
            }
