...
public class TiendaController {
    ...
    /**
     * Endpoint público — devuelve todas las tiendas con lat/lng para el mapa Leaflet.
     * No requiere autenticación (permitAll en SecurityConfig).
     */
    @GetMapping("/todas")
    public List<TiendaDTO> todasLasTiendas() {
        return tiendaService.findAll();
    }

    @GetMapping("/{id}")
    public TiendaDTO tiendaPorId(@PathVariable Long id) {
